...
class Es_Dashboard_Page extends Es_Object
{
    ...
    public static function get_changelog_list()
    {
        return apply_filters( 'es_get_changelog_list', array(
	        __( '3.11.8 (December, 2, 2021)', 'es-plugin' ) => '<ul>
				<li>FIX: Elementor single property page document fixed</li>
				<li>FIX: Property management map address components generation fixed</li>
				<li>FIX: minor fixed</li>
			</ul>',

	        __( '3.11.7 (November, 23, 2021)', 'es-plugin' ) => '<ul>
				<li>FIX: Thumb images issue on single property page fixed (all versions)</li>
				<li>FIX: Links issue in email about new listing from agent fixed (all versions)FIX: minor fixes</li>
				<li>FIX: Fixed labels field in Elementor listings widget (All versions)</li>
				<li>FIX: MLS Rooms import fixed (Premium)</li>
				<li>FIX: minor fixes</li>
			</ul>',

	        __( '3.11.6 (November, 4, 2021)', 'es-plugin' ) => '<ul>
				<li>NEW: Filter for meta search query added (all versions)</li>
				<li>NEW: Search query optimized (PRO & Premium)</li>
				<li>NEW: Room title field added for rets import (Premium)</li>
				<li>FIX: Map sql filter fixed (single property URL issue) (all versions)</li>
				<li>FIX: Deleted google + from plugin settings (all versions)</li>
				<li>FIX: wp filter before search field render added (all versions)</li>
				<li>FIX: DIVI conflict - header/footer broken fixed (all versions)</li>
				<li>FIX: Property gallery issue fixed (all versions)</li>
				<li>FIX: Markup for custom fields on single property page fixed (all versions)</li>
				<li>FIX: Conflict with plugin Yoast SEO fixed (all versions)</li>
				<li>FIX: Listings with specified Ids in slideshow fixed (all versions)</li>
				<li>FIX: Divi builder integrtion fixed (all versions)</li>
				<li>FIX: Request form js context added (all versions)</li>
				<li>FIX: Changed algorithm of render single property page content (all versions)</li>
				<li>FIX: Different version of slick slider fixed (Simple & PRO)</li>
				<li>FIX: Agent\'s name display issue in Saved Search fixed (PRO & Premium)</li>
				<li>FIX: Property management layout conflict with Gutenberg fixed (PRO & Premium)</li>
				<li>FIX: Links in email about new listing from agent fixed (PRO & Premium)</li>
				<li>FIX: CSV\MLS google api key settings field fixed (PRO & Premium)</li>
				<li>FIX: Decreased query limit for import rooms & open houses (Premium)</li>
				<li>minor fixes</li>
			</ul>',

	        __( '3.11.5 (September, 20, 2021)', 'es-plugin' ) => '<ul>
				<li>HOTFIX: Map sql filter fixed (single property URL issue) (PRO & Premium)</li>
			</ul>',
