...
Tags: woocommerce,woocommerce bulk edit,bulk edit,bulk,products editor,products manager
...
BEAR - WooCommerce Bulk Edit and Products Manager Professional is WordPress plugin for bulk edit woocommerce products and manage their data in the robust and flexible way!

== Description ==

**Products Bulk Editor and Products Manager for WooCommerce** (BEAR) (old name is WOOBE) is WordPress plugin for woocommerce bulk edit and managing woocommerce products in the robust and flexible way! Be professionals with managing data of your woocommerce e-shop!

Latest PHP 8.x - COMPATIBLE! WooCommerce compatibility: from v.3.6 to the latest WooCommerce version.
...
R: [https://pluginus.net/support/forum/woobe-woocommerce-bulk-editor-professional/](https://pluginus.net/support/forum/woobe-woocommerce-bulk-editor-professional/)
...
= 2.0.6 =
* [https://bulk-editor.com/update-v-2-0-9-v-1-0-9/](https://bulk-editor.com/update-v-2-0-9-v-1-0-9/)
...
* ability to set fields empty: [https://bulk-editor.com/howto/how-to-set-empty-value/](https://bulk-editor.com/howto/how-to-set-empty-value/)
* hook 'woobe_storage_type' to fix filtering if troubles with session [https://bulk-editor.com/document/more-settings-implicit/](https://bulk-editor.com/document/more-settings-implicit/)

= 1.0.7 =
* 1 jQuery fix for WordPress 5.6 compatibility

= 1.0.6.3 =
* renaming WOOBE to BEAR
* code sanitizing
* 1 fix for export links

= 1.0.6.2 =
* 1 possible security fix

= 1.0.6.1 =
* 1 hot fix in ext\bulk\views\panel.php #663

= 1.0.6 =
* [https://bulk-editor.com/update-2-0-6/](https://bulk-editor.com/update-2-0-6/)
...
* Feature. Now it is possible to convert simple product into variative product and this product price will be attached to all variations
...
* [https://bulk-editor.com/update-2-0-5/](https://bulk-editor.com/update-2-0-5/)
