...
jQuery(function ($) {
    ...
    jQuery(document).on("do_tabs-woobe-bulkoperations-delete", {}, function () {
        ...
        jQuery('#bulkoperations_attributes_delete').unbind('change');
        jQuery('#bulkoperations_attributes_delete').change(function () {
        ...
        jQuery('#bulkoperations_attributes_delete_how').unbind('change');
        jQuery('#bulkoperations_attributes_delete_how').change(function () {
