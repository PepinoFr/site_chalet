...
function woobe_act_meta_popup_editor(_this) {
    ...
    jQuery('.woobe-modal-save10').unbind('click');
    ...
    jQuery('.woobe-modal-close10').unbind('click');
...
function __woobe_init_meta_popup_editor() {
    ...
    jQuery('.meta_popup_editor_insert_new').unbind('click');
    ...
    jQuery('.meta_popup_editor_insert_new_o').unbind('click');
    ...
    jQuery('.meta_popup_editor_add_sub_item, .meta_popup_editor_add_sub_item2').unbind('click');
    ...
    jQuery('.meta_popup_editor_li_key').unbind('click');
    jQuery('.meta_popup_editor_li_key').keyup(function () {
