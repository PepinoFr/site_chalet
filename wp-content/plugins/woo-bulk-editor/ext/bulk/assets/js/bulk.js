...
jQuery(function ($) {
    ...
    jQuery('.woobe_num_rounding').change(function () {
...
function woobe_init_bulk_panel() {
    ...
    jQuery('.woobe_bulk_add_special_key').change(function () {
    ...
    jQuery('.woobe_bulk_value_signs').change(function () {
        ...
        if (jQuery(select).val()) {
            ...
            jQuery.ajax({
                ...
                success: function (html) {
                    ...
                    jQuery('.woobe_bulk_get_att_terms_del').unbind('click');
